...
const products = [
  {
    ...
    shortDescription: "Premium quality popcorn maize sourced from Karnataka's best farms.",
    fullDescription:
    ...
    features: ["High expansion ratio", "Uniform kernel size", "Rich flavor", "Properly dried and stored"],
  },
  {
    id: 2,
    ...
    price: "₹80-95 per kg",
    image: "/placeholder.svg?height=300&width=300",
    shortDescription: "Nutritious chickpeas rich in protein and fiber, perfect for various culinary uses.",
    fullDescription:
    ...
    features: ["High protein content", "Rich in fiber", "Carefully cleaned and sorted", "Versatile culinary uses"],
  },
  {
    id: 3,
    name: "Chia Seeds",
    ...
    image: "/placeholder.svg?height=300&width=300",
    shortDescription: "Superfood chia seeds packed with omega-3 fatty acids and antioxidants.",
    fullDescription:
  ...
  },
  {
    ...
    price: "₹35-50 per kg",
    image: "/placeholder.svg?height=300&width=300",
    shortDescription: "High-quality rice varieties including basmati and traditional Karnataka rice.",
    fullDescription:
    ...
    features: ["Multiple varieties available", "Aromatic and flavorful", "Carefully processed", "Free from impurities"],
  },
  {
    id: 5,
    ...
    price: "₹60-75 per kg",
    image: "/placeholder.svg?height=300&width=300",
    shortDescription: "Nutritious finger millet (ragi) - a traditional superfood from Karnataka.",
    fullDescription:
    ...
    features: ["Rich in calcium and iron", "Gluten-free", "Low glycemic index", "Traditional processing methods"],
  },
]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto px-4">
            We specialize in sourcing and supplying high-quality agricultural products directly from Karnataka's fertile
            regions. Our products are carefully selected, processed, and packed to ensure maximum quality and freshness.
          </p>
        </div>
            ...
            return (
              <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="text-lg sm:text-xl font-bold text-gray-800">{product.name}</CardTitle>
                  <p className="text-base sm:text-lg font-semibold text-green-600">{product.price}</p>
                </CardHeader>
